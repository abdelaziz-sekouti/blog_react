...
function Testemonials({ testimonials }) {
  return (
    <section style={wrapper} aria-labelledby="testemonials-heading">
      ...
      <p style={subtitle}>
        Real feedback from readers and collaborators. Short, honest reflections
        to help you understand the value we deliver.
      </p>
        ...
        {testimonials.map((t, i) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ marginTop: "auto", color: "#f59e0b" }} aria-hidden>
